<div {{ $attributes->merge(['class' => 'flex items-center mt-8']) }}>
    <a href="https://www.facebook.com/thecodeholic" target="_blank"
        class="
           w-10
           h-10
           flex
    ...
    <a href="https://twitter.com/thecodeholic" target="_blank"
        class="
         w-10
         h-10
         flex
    ...
    <a href="https://youtube.com/TheCodeholic" target="_blank"
        class="
         w-10
         h-10
         flex
    ...
    <a href="https://www.instagram.com/thecodeholic" target="_blank"
        class="
         w-10
         h-10
         flex

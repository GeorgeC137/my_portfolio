...
<section class="relative z-10 overflow-hidden bg-slate-700 py-20 lg:py-[120px] dark:bg-primary" id="contact">
    <div class="container">
        <div class="flex flex-wrap -mx-4 lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                    ...
                    <h2
                        class="text-dark dark:text-gray-100 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            <h4 class="text-dark dark:text-gray-200 mb-1 text-xl font-bold">Phone Number</h4>
                            <p class="text-body-color text-base dark:text-gray-300">(+254)76 983 7693</p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                        ...
                        <div class="w-full">
                            <h4 class="text-dark dark:text-gray-200 mb-1 text-xl font-bold">Email Address</h4>
                            <p class="text-body-color text-base dark:text-gray-300">omollogeorge17@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="rounded-lg bg-white p-8 shadow-lg sm:p-12 dark:bg-slate-900 relative">
                    <form action="{{ route('contact.submit') }}" method="POST" x-data="{
                        ...
                        <div class="mb-6">
                            <x-forms.input type="phone" placeholder="Your PhoneNumber" name="phone"
                                x-model="formData.phone" ::class="errors.phone ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
                            <template x-if="errors.phone">
                                <div x-text="errors.phone[0]" class="text-red-500"></div>
                            </template>
                        </div>
                        <div class="mb-6">
